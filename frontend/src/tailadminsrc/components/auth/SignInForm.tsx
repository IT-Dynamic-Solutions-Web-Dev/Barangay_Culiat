...
export default function SignInForm() {
  ...
  return (
    <div className="h-screen flex bg-slate-50 overflow-hidden ">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] overflow-hidden rounded-tr-2xl rounded-br-2xl">
            ...
            <div className="space-y-2.5">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3.5 border border-white/20">
                ...
                <p className="text-white/80 text-xs leading-relaxed">
                  Oversee resident information, document requests, and community
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-3.5 border border-white/20">
                ...
                <p className="text-white/80 text-xs leading-relaxed">
                  Monitor reports, announcements, and activities happening in
                  the barangay in real-time.
                </p>
              </div>
            </div>
          </div>
