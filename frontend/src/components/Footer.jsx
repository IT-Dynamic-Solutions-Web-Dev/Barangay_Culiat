...
const Footer = () => {
  return (
    <footer className="bg-[#b30000] text-white py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <div className="w-6 h-6 bg-[#b30000] rounded-full"></div>
              </div>
              <div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-2">
                ...
                <div>
                  <p className="text-white/90">Barangay Hall, Culiat</p>
                  <p className="text-white/90">Quezon City, Metro Manila</p>
                </div>
              </div>
              <div className="flex items-center space-x-2">
                ...
                <p className="text-white/90">info@barangayculiat.gov.ph</p>
              </div>
              <div className="flex items-center space-x-2">
                <svg
                  className="w-4 h-4 flex-shrink-0"
                ...
                <p className="text-white/90">(02) 000-0000</p>
              </div>
              <div className="flex items-start space-x-2">
          ...
          <div>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-4 flex items-center justify-center h-32">
              {/* <MapPin size={48} className="text-white/50" /> */}
            </div>
            <p className="text-sm text-white/90 mb-3">
              Visit our barangay hall for in-person services and assistance.
            </p>
            <button className="bg-white text-[#b30000] px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors flex items-center space-x-2">
              {/* <MapPin size={16} /> */}
