...
import { ClipboardList, Plus, Filter, ArrowLeft, Clock, MapPin, AlertCircle } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="font-semibold text-[var(--color-text-color)]">Filters</h3>
          </div>
        ...
        {loading ? (
          ...
          >
            <div className="text-center">
              ...
              <p className="text-[var(--color-text-secondary)]">Loading reports...</p>
            </div>
          </motion.div>
            ...
            {filteredReports.map((report, index) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                  ...
                  <span className={`px-4 py-1.5 rounded-full text-sm font-semibold border whitespace-nowrap ${getStatusStyles(report.status)}`}>
                    {report.status}
                  </span>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-[var(--color-text-secondary)]">
                  ...
                  <span className={`flex items-center gap-1.5 capitalize ${getPriorityStyles(report.priority)}`}>
                ...
                {isAdmin && report.reportedBy && (
                  <div className="mt-4 pt-4 border-t border-[var(--color-neutral-active)] text-sm text-[var(--color-text-secondary)] italic">
                    Reported by: <span className="font-medium">{report.reportedBy.firstName} {report.reportedBy.lastName}</span>
                  </div>
                )}
              </motion.div>
            ))}
