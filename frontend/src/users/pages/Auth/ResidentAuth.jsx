...
export default function ResidentAuth() {
  ...
  return (
    <div className="h-screen flex bg-slate-50 overflow-hidden w-full">
      {/* <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] overflow-hidden rounded-br-2xl rounded-tr-2xl">
